  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-blue-900 via-blue-800 to-blue-900">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-10 right-10 w-24 h-24 rounded-full bg-yellow-100 shadow-[0_0_60px_30px_rgba(251,191,36,0.3)]" />
      ...
      >
        <svg width="500" height="200" viewBox="0 0 500 200" className="w-40 sm:w-56 md:w-64 lg:w-[500px]">
          ...
          <ellipse cx="455" cy="110" rx="8" ry="6" fill="#fef3c7" />
          <ellipse cx="455" cy="110" rx="12" ry="10" fill="rgba(251,191,36,0.3)" />
      ...
      <div className="relative z-20 text-center px-4 max-w-4xl mx-auto">
        <div className="mb-6">
          <span className="inline-block px-4 py-2 bg-amber-400/20 text-amber-400 rounded-full text-sm font-medium border border-amber-400/30">
        ...
        <p className="text-sm sm:text-lg md:text-xl text-blue-100 mb-6 sm:mb-8 max-w-2xl mx-auto">
        ...
        <div className="mb-8 sm:mb-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
          ...
          <button className="px-4 py-2 sm:px-8 sm:py-4 bg-transparent border-2 border-white text-white font-semibold rounded-full text-sm sm:text-lg transition-all duration-300 hover:bg-white hover:text-blue-900">
            Lihat Rute
          </button>
        </div>
        ...
        <div className="mt-8 sm:mt-16 grid grid-cols-3 gap-4 sm:gap-8 max-w-lg mx-auto">
          <div className="text-center">
            ...
            <div className="text-xs sm:text-sm text-blue-200">Pelanggan Puas</div>
          </div>
          <div className="text-center">
